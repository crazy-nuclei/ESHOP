...
import { addToCart, deleteFromCart } from '../redux/reducers/cart/cart.actions';
        ...
        <Col md={4}>
            <Card>
                <ListGroup variant="flush">
                    ...
                    <ListGroup.Item>
                        <Row><Button type='button' className='btn-block' disabled={cartItems.length === 0} onClick={checkOutHandler} >Proceed To checkout</Button></Row>
                    </ListGroup.Item>
                </ListGroup>
            </Card>
        </Col>
